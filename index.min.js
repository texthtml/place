...
define("components/angular/angular", (function (global) {
    return function () {
        var ret, fn;
...
;
define("components/photoswipe/release/3.0.3/lib/klass.min", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.klass;
    };
}(this)));
...
define("components/photoswipe/release/3.0.3/code.photoswipe-3.0.3.min", ["components/photoswipe/release/3.0.3/lib/klass.min"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.Code.PhotoSwipe;
    };
}(this)));
...
define("components/angularjs-foursquare/angularjs-foursquare", function(){});
...
define("components/angularjs-webapp/angularjs-webapp", function(){});
...
define("components/angularjs-geolocation/angularjs-geolocation", function(){});
